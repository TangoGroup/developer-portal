...
## What is required when making requests?

First, you must decide which publisher you would like to query. First, navigate to the [Organizations page](https://studio.ai.gloo.com/organizations), and click "View Publishers" for the organization's publisher you're querying.

![](/images/docs/b9826a289792fd8b974e689235681fd906182643d341d551eb6b7a13c5f7a81b-Gloo_AI_Studio_Analyze_Overview_2025-05-16_at_1.01.58_PM.jpg)

Then, find the publisher's name, and remove any spaces. That is your tenant name. In this example, the tenant will be **TestOrg**.

![](/images/docs/1b6bb45375bc22ba20b2651454e7c122d035a0f898a93b2c724a433e9a9c542c-Gloo_AI_Studio_Analyze_Overview_2025-05-16_at_1.05.34_PM.jpg)

## What is a Collection?

A collection is where we keep the content for our customers. The only collection you'll need to specify in requests is `DataEngineProd`. You must specify this in the `collection` field.

## What is a Tenant?

Tenants are a cordoned-off barrier between your content, and those of our other customers. Only the API credentials for your organization will be allowed access to your content. Again, this is your publisher name, with all spaces removed. You must specify this in the `tenant` field.
...
Once you have your tenant name, you're ready to query the search endpoint.
...
You can acquire an API key by visiting the [API Credentials page](https://studio.ai.gloo.com/build/keys) and then following [these instructions](https://docs.ai.gloo.com/update/docs/generating-api-credentials#/) to generate a token using the OAuth2 Client Credentials flow.
...
* * [What is Search?](#what-is-search)
  ...
  * [Why use Search?](#why-use-search)

  * * [Search your content](#search-your-content)
    * [RAG - Retrieval Augmented Generation](#rag---retrieval-augmented-generation)

  * [What is required when making requests?](#what-is-required-when-making-requests)

  * [What is a Collection?](#what-is-a-collection)

  * [What is a Tenant?](#what-is-a-tenant)

  * [How many records can I retrieve?](#how-many-records-can-i-retrieve)
